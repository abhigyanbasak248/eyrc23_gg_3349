...
stored_centres = {207: (305,435), 201: (225,435), 200: (690, 635), 203: (490, 580), 202: (490, 705), 204: (235, 830), 205: (685, 435)}
# 201: (173,435), 206: (490, 410)
...
while True:
    ...
    for dict_name, dict_value in ARUCO_DICT.items():
        ...
        for stored_id, stored_center in stored_centres.items():
            ...
            if distance < min_distance and stored_id != moving_id and distance < 60:  # Adjust the distance threshold
