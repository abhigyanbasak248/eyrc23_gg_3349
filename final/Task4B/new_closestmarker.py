...
stored_centres = {200: (653, 635), 201: (173,435), 203: (460, 555), 202: (460, 705), 204: (240, 850)}
...
while True:
    ...
    for dict_name, dict_value in ARUCO_DICT.items():
        ...
        for stored_id, stored_center in stored_centres.items():
            ...
            if distance < min_distance and stored_id != moving_id and distance < 80:  # Adjust the distance threshold
